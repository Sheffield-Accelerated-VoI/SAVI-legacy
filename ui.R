# Copyright (c) 2014 - 2025 the SAVI authors (see AUTHORS.txt).
...
fluidPage(
  ...
  headerPanel(HTML("
                  ...
                  SAVI - Sheffield Accelerated Value of Information (Legacy Version)")),
  mainPanel(
    h4("Release version 2.2.1 (2025-02-11) - LEGACY VERSION"),
    ...
    tabsetPanel(
      tabPanel(
        ...
        sidebarLayout(
          ...
          sidebarPanel(
            h3("Contact Us"),
            p(
              HTML("For any queries or to report a bug please send an email to "),
              a("savi@sheffield.ac.uk", href = "mailto:savi@sheffield.ac.uk")
            ),
            br(),
            h3("New version of SAVI available"),
            p(
              "A new improved version of SAVI is available ",
              a("here.",
                target = "_blank", rel = "noopener noreferrer",
                href = "https://savi.shef.ac.uk/SAVI/"
              )
            ),
            br(),
            h3("News"),
            p(
              HTML("<strong>SAVI is now available as an R package</strong>, allowing you to run SAVI directly on your own machine.
            ...
            p(
              HTML("This means that traffic to and from SAVI is now encrypted. The old"),
            ...
            p(HTML("We have added a new 'Risk Analysis' tab. SAVI now generates Risk Analysis charts as described in "), a("this
              paper by Grimm et al.", target = "_blank", rel = "noopener noreferrer", href = "https://link.springer.com/article/10.1007%2Fs40273-017-0562-9")),
          ...
          mainPanel(
            ...
            p(HTML("Disclaimer: This application is based on peer-reviewed
              ...
              The <a href = 'https://github.com/Sheffield-Accelerated-VoI/SAVI'
                target='_blank' rel='noopener noreferrer'>underlying code</a> is made available under the
              <a href = 'https://raw.githubusercontent.com/Sheffield-Accelerated-VoI/SAVI/master/LICENSE.txt'
                   target = '_blank' rel='noopener noreferrer'>BSD 3-clause license</a>.")),
            ...
            p(HTML("<div style='border:1px solid
              ...
              <a href='https://pubmed.ncbi.nlm.nih.gov/24246566/' target='_blank' rel='noopener noreferrer'>here.</a></div>")),
            br(),
      ...
      tabPanel(
        ...
        textInput("effectDef",
          label = h5(strong("Definition of effectiveness measure")),
          value = "Discounted Lifetime QALYs"
        ),
        textInput("costDef",
          label = h5(strong("Definition of cost measure")),
          value = "Discounted Lifetime Costs (£)"
        ),
        numericInput("annualPrev",
          label = h5(strong("Annual prevalence within jurisdiction
        ...
        textInput("jurisdiction",
          label = h5(strong("Name of jurisdiction (e.g. country, region, city)")),
          value = "England"
        )
      ),
      ...
      tabPanel(
        "Import files", # Button to import parameter data
        sidebarLayout(
          position = "right",
          sidebarPanel(
      ...
      tabPanel(
        ...
        p(HTML("For subsets with up to five parameters, the GAM regression method is used.
          ...
          See <a href='https://pubmed.ncbi.nlm.nih.gov/24246566/'
                target='_blank' rel='noopener noreferrer'>this paper</a> for details.")),
        br(),
        sidebarLayout(
          sidebarPanel(
      ...
      tabPanel(
        ...
        p(HTML("The concepts are explained in detail in this
                           ...
                           target='_blank' rel='noopener noreferrer'>NICE Decision Support Unit Report</a>, and in
                            <a href = 'https://link.springer.com/article/10.1007%2Fs40273-017-0562-9'
                           target='_blank' rel='noopener noreferrer'>this paper by Grimm et al</a>.")),
        br(),
      ...
      tabPanel(
        ...
        p(HTML("This web tool is an
              <a href = 'http://shiny.rstudio.com/' target='_blank' rel='noopener noreferrer'>R Shiny Server application</a>.")),
        p(HTML("It was written at the University of Sheffield's
              <a href = 'http://www.sheffield.ac.uk/scharr'
                target='_blank' rel='noopener noreferrer'>School of Health and Related Research</a> by
              <a href='https://www.shef.ac.uk/scharr/sections/ph/staff/profiles/mark'
                target='_blank' rel='noopener noreferrer'>Mark Strong</a>,
              <a href='https://www.sheffield.ac.uk/scharr/sections/heds/staff/breeze_p'
                target='_blank' rel='noopener noreferrer'>Penny Breeze</a>,
              <a href='https://www.sheffield.ac.uk/scharr/sections/heds/staff/thomas_c'
                target='_blank' rel='noopener noreferrer'>Chloe Thomas</a>,
              <a href='https://www.sheffield.ac.uk/scharr/sections/heds/staff/brennan_a'
                target='_blank' rel='noopener noreferrer'>Alan Brennan</a> and
              <a href='http://www.imperial.ac.uk/people/christophe.stevens'
                target='_blank' rel='noopener noreferrer'>Christophe Stevens</a>.")),
        p(HTML("The regression-based method for approximating partial EVPI was developed by
         <a href='https://www.shef.ac.uk/scharr/sections/ph/staff/profiles/mark'
          target='_blank' rel='noopener noreferrer'>Mark Strong</a>
              in collaboration with
              <a href='http://www.jeremy-oakley.staff.shef.ac.uk/' target='_blank' rel='noopener noreferrer'>Jeremy Oakley</a>
              and <a href='https://www.sheffield.ac.uk/scharr/sections/heds/staff/brennan_a'
              target='_blank' rel='noopener noreferrer'>Alan Brennan</a>.")),
        p(HTML("The source code is available on GitHub at
        <a href = 'https://github.com/Sheffield-Accelerated-VoI/SAVI'
              target='_blank' rel='noopener noreferrer'>https://github.com/Sheffield-Accelerated-VoI/SAVI.</a>")),
        ...
        p(HTML("This website complies with The University of Sheffield's
          <a href='http://www.sheffield.ac.uk/privacy' target='_blank' rel='noopener noreferrer'>Privacy
         Policy</a>")),
        p(HTML("<a href='http://www.nihr.ac.uk/'
                    target='_blank' rel='noopener noreferrer'><img src = 'NIHR-Logo.png' width = '200'
    ...
    tags$style(
      type = "text/css", ".tab-content { overflow: visible; }",
